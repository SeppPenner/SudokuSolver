...
namespace SudokuSolver
{
    ...
    public partial class Main : Form
    {
        ...
        private void CompleteSolve(SudokuBoard board)
        {
            ...
            dialog.WriteLine(this.language.GetWord("Board"));
            var outputSolution = board.OutputSolution();
            dialog.WriteLine(outputSolution);
            var solutions = board.Solve().ToList();
            dialog.WriteLine(this.language.GetWord("BaseBoardProgress"));
            dialog.WriteLine(outputSolution);
            dialog.WriteLine(this.language.GetWord("2Minus"));
            dialog.WriteLine(this.language.GetWord("2Minus"));
            dialog.WriteLine(string.Format(this.language.GetWord("AllSolutions"), solutions.Count));
            var i = 1;
            ...
            {
                dialog.WriteLine(this.language.GetWord("16Minus"));
                dialog.WriteLine(string.Format(this.language.GetWord("SolutionOf"), i++, solutions.Count));

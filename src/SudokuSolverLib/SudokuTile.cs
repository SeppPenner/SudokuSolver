...
public class SudokuTile
{
    ...
    public int Value
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentOutOfRangeException(string.Format(language.GetWord("TileValueCantBeGreaterThan") ?? string.Empty, value));
            }
    ...
    public override string ToString()
    {
        ...
        return string.Format(language.GetWord("ValueAtPosXY") ?? string.Empty, this.Value, this.X, this.Y);
    }
    ...
    internal void Fix(int valueParam, string reason)
    {
        ...
        Console.WriteLine(language.GetWord("FixingOnPositionReason") ?? string.Empty, valueParam, this.X, this.Y, reason);
    ...
    internal SudokuProgress RemovePossibles(IEnumerable<int> existingNumbers)
    {
        ...
        if (this.possibleValues.Count == 1)
        {
            ...
            this.Fix(this.possibleValues.First(), language.GetWord("OnlyOnePossibility") ?? string.Empty);

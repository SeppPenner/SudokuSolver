...
namespace SudokuSolverLib
{
    ...
    public static class SudokuFactory
    {
        ...
        public static SudokuBoard ClassicWith3X3BoxesAndHyperRegions(ILanguage languageParam)
        {
            ...
            board.CreateRule(language.GetWord("HyperA"), from pos in Box(3, 3) select board.Tile(pos.Item1 + HyperMargin, pos.Item2 + HyperMargin));
            board.CreateRule(language.GetWord("HyperB"), from pos in Box(3, 3) select board.Tile(pos.Item1 + HyperSecond, pos.Item2 + HyperMargin));
            board.CreateRule(language.GetWord("HyperC"), from pos in Box(3, 3) select board.Tile(pos.Item1 + HyperMargin, pos.Item2 + HyperSecond));
            board.CreateRule(language.GetWord("HyperD"), from pos in Box(3, 3) select board.Tile(pos.Item1 + HyperSecond, pos.Item2 + HyperSecond));
            return board;
        }
